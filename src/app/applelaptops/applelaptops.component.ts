...
@Component({
  selector: 'app-applelaptops',
  standalone: true,
  imports: [CommonModule,RouterLink],
  templateUrl: './applelaptops.component.html',
  styleUrl: './applelaptops.component.css'
})
export class ApplelaptopsComponent implements  OnInit {
  cartItemCount: number=0;
  // showLoginForm: boolean = false; // Declare showLoginForm property
  ...
  products: Product[] = [
    // ...........card1....................
    {
      ...
      options: [
        ...
        { imageUrl: 'assets/Applelaptops/apple1536' },
        { imageUrl: 'assets/Applelaptops/apple11' },
    ...
    },
    {
      ...
      title: 'Gaming Laptop',
      price: '₹64,999',
      imageUrl: 'assets/Applelaptops/app',
      description: 'Dell G5 Gaming Laptop Intel Core i7 10th Gen - (16 GB/1 TB SSD/Windows 10 Home) G5 5500',
      options: [
        { imageUrl: 'assets/images/laptop6.jpeg' },
        { imageUrl: 'assets/images/laptop7.jpeg' },
    ...
    },
    {
      ...
      description: 'Apple G5 Gaming Laptop Intel Core i7 10th Gen - (16 GB/1 TB SSD/Windows 10 Home) G5 5500',
      options: [
        { imageUrl: 'assets/Applelaptops/apple24.1' },
        { imageUrl: 'assets/Applelaptops/apple24.2' },
        { imageUrl: 'assets/Applelaptops/apple24.3' },
        { imageUrl: 'assets/Applelaptops/apple24.4' },
        { imageUrl: 'assets/Applelaptops/apple24.5' }
      ],
      colors: [
        {
          backgroundColor: '#000',
          imageUrl: 'assets/Applelaptops/apple24black',
          active: true,
          optionImages: [
            { imageUrl: 'assets/Applelaptops/apple24.1black' },
        { imageUrl: 'assets/Applelaptops/apple24.2black' },
        { imageUrl: 'assets/Applelaptops/apple24.3black' },
        { imageUrl: 'assets/Applelaptops/apple24.4black' },
        { imageUrl: 'assets/Applelaptops/apple24.5black' },
          ]
        },
        {
          backgroundColor: 'gray',
          imageUrl: 'assets/Applelaptops/apple24sliver',
          active: false,
          optionImages: [
            { imageUrl: 'assets/Applelaptops/apple24.1sliver' },
            { imageUrl: 'assets/Applelaptops/apple24.2sliver' },
            { imageUrl: 'assets/Applelaptops/apple24.3sliver' },
            { imageUrl: 'assets/Applelaptops/apple24.4sliver' },
            { imageUrl: 'assets/Applelaptops/apple24.5sliver' },
          ]
        }
      ],
      sizes: [{ label: '15.6 inch' }, { label: '17 inch' }],
