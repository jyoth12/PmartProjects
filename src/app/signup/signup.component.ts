...
export class SignupComponent implements  AfterViewInit {
  ...
  currentForm: 'Otp'| 'signin'|'signin' | 'signup' | 'Forget' | 'Reset' | null = null;
  ...
  displayContent(formType:|'Otp'| 'signin'|'signin' | 'signup' | 'Forget' | 'Reset'): void {
  ...
  onSubmitSignIn(): void {
    ...
    this.http.post('http://localhost:9000/api/login', userData).subscribe(
      (response: any) => {
